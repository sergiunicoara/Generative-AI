const { VERSES_2SAMUEL_MASTER } = require("./js/verses-2samuel-master.js");
console.log("Total verses in 2 Samuel master:", VERSES_2SAMUEL_MASTER.length);
let errors = [];
for (const v of VERSES_2SAMUEL_MASTER) {
